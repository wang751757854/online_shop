...
<div id="sidebar" class="span3">
					<ul id="sideManu" class="nav nav-tabs nav-stacked">
						<li class="subMenu open"><a>图书/数码/手机</a>
							<ul>
								<li><a class="active" href="lookKindShop?kind=教育"><i
										class="icon-chevron-right"></i>教育</a></li>
								<li><a href="lookKindShop?kind=文艺"><i
										class="icon-chevron-right"></i>文艺</a></li>
								<li><a href="lookKindShop?kind=生活"><i
										class="icon-chevron-right"></i>生活</a></li>
								<li><a href="lookKindShop?kind=科技"><i
						...
						<li class="subMenu"><a>美食/零食/水果</a>
							<ul style="display: none">
								...
								<li><a href="lookKindShop?kind=蜜饯果干"><i
										class="icon-chevron-right"></i>蜜饯果干</a></li>
								<li><a href="lookKindShop?kind=蛋糕饼干"><i
						...
						<li class="subMenu"><a>美妆/洗护/清洁</a>
							<ul style="display: none">
								...
								<li><a href="lookKindShop?kind=洗发护发"><i
										class="icon-chevron-right"></i>洗发护发</a></li>
								<li><a href="lookKindShop?kind=口腔护理"><i
